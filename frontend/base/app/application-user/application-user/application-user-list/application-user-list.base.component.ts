...
detailComponent= 'ApplicationUserDetailBaseComponent'; //adding the detail component here
...
changedSearchReferenceValues: any = {};
  ...
  "sortOrder" : "asc",
  "detailPage" : {
    "sid" : "fb6d69eb-2299-4423-9c63-334dbb2ad94b",
...
public location = inject(Location);
    ...
    const dynamicDialogRef = this.dialogService.open(ApplicationUserDetailComponent, {
      showHeader: true,
      closable: false,
      position: "top",
      closeOnEscape: false,
   ...
   const config = this.getButtonConfig(btn);
    ...
    if (btn.action === 'navigate_to_page' && btn.pageName?.url) {
      ...
      const onSave: Exclude<keyof ApplicationUserListBaseComponent, ' '> = methodName.split('_')[0];
